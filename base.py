...
LOCATION, WHATUSERWANTS, BMICALCULATORHELPER, SELECTREMOVE = range(4)
...
def main():
	...
	conv_handler = ConversationHandler(
		entry_points=[CommandHandler('start', start), CommandHandler('help',help), CommandHandler('viewpeople',view_people), CommandHandler('bmicalculator',bmi_calculator), CommandHandler('setreminder', set_timer,pass_args = True,
								  pass_job_queue = True,
								  pass_chat_data = True)],
		states={
